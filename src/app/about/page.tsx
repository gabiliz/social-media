				...
				<div className="grid grid-cols-3 gap-8">
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Mario.jpg" alt="Mario image"/>
					...
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Luigi.jpg" alt="Mario image"/>
					...
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Peach.jpg" alt="Mario image"/>
					...
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Yoshi.jpg" alt="Mario image"/>
					...
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Donkey-Kong.jpg" alt="Mario image"/>
					...
					<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
						<div className="flex flex-col items-center py-10">
								<img className="w-50 h-50 mb-3 rounded-3xl" src="/Bowser.jpg" alt="Mario image"/>
